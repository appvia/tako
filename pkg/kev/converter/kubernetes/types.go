...
// @todo: Check whether we could just reuse native compose.ServiceConfig instead of wrapping things in another object?
...
type ConvertOptions struct {
	...
	CreateD                     bool // Create service as Deployment
	CreateRC                    bool // Create service as ReplicationController
	CreateDS                    bool // Create service as DaemonSet
	...
	InputFiles                  []string // Compose file to be processed
...
type ServiceConfig struct {
	...
	Configs            []compose.ServiceConfigObjConfig   `compose:""` //LONG SYNTAX link(https://docs.docker.com/compose/compose-file/#long-syntax)
	ConfigsMetaData    map[string]compose.ConfigObjConfig `compose:""` //SHORT SYNTAX link(https://docs.docker.com/compose/compose-file/#configs)
}
...
// @todo: Could use already extracted information here instead!
func (s *ServiceConfig) GetKubernetesUpdateStrategy() *v1beta1.RollingUpdateDeployment {
