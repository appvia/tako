...
require (
	github.com/GoogleContainerTools/skaffold/v2 v2.24.0
...
require (
	...
	github.com/buildpacks/lifecycle v0.21.11 // indirect
	...
	github.com/pterm/pterm v0.12.24 // indirect
...
replace (
	github.com/alessio/shellescape => al.essio.dev/pkg/shellescape v1.4.1
	// Also mirrored from skaffold: ko needs the yaml.v3-based go-yit, and
	// apimachinery v0.33.4 needs a kube-openapi that still emits
	// structured-merge-diff/v4 types.
	...
	// Mirror skaffold's k8s pins: skaffold requires the ancient k8s.io/client-go
	// v1.5.2 tag and neutralizes it with these replaces, which do not apply
